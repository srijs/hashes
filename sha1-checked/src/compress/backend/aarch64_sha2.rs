//! SHA-1 `aarch64` backend, spilling the message schedule alongside the
//! digest.

use crate::compress::soft::K;

#[cfg(not(target_arch = "aarch64"))]
compile_error!("aarch64_sha2 backend can be used only on aarch64 target arches");
